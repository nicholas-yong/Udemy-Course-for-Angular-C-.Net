...
namespace MoviesAPI.Controllers
{
    ...
    public class MovieController : ControllerBase
    {
        ...
        public MovieController(ApplicationDbContext context, IMapper mapper, IFileStorageService fileStorageService, UserManager<IdentityUser> userManager)
        {
        ...
        public async Task<ActionResult<MoviePostGetDTO>> PostGet()
        {
            ...
            return new MoviePostGetDTO() { genres = genresDTO, theaters = movieTheatersDTO };
        }
        ...
        public async Task<ActionResult<MovieDTO>> Get(int id)
        {
            var movie = await context.Movies
                ...
                .Include(x => x.MovieMovieTheaters).ThenInclude(x => x.MovieTheater)
        ...
        public async Task<ActionResult> Put(int id, [FromForm] MovieCreationDTO movieCreationDTO)
        {
            var movie = await context.Movies.Include(x => x.MoviesActors)
                ...
                .Include(x => x.MovieMovieTheaters)
                .FirstOrDefaultAsync(x => x.Id == id);
