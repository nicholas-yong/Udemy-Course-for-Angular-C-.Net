...
const routes: Routes = [
  ...
  {path: 'movietheaters', component: IndexMovieTheatherComponent, canActivate: [IsAdminGuard]},
  {path: 'movietheaters/create', component: CreateMovieTheatherComponent, canActivate: [IsAdminGuard]},
