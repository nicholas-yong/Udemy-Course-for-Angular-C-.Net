...
export class MovieDetailsComponent implements OnInit {
  ...
  constructor(private movieService: MoviesService, private activatedRoute: ActivatedRoute, private sanitzer: DomSanitizer, public ratingsService: RatingService) { }
  ...
  generateYoutubeURLForEmbeddedVideo(url: any): SafeResourceUrl
  {
    ...
    return this.sanitzer.bypassSecurityTrustResourceUrl(`https://www.youtube.com/embed/${videoId}`)
  }
